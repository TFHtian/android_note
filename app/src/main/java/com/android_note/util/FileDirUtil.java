package com.android_note.util;

import android.content.Context;
import android.os.Environment;
import android.os.storage.StorageManager;

import com.android_note.app.BaseApplication;
...
public class FileDirUtil {
    ...
    public String getExternalCacheDir(){
        File dir = BaseApplication.getInstance().getExternalCacheDir();
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getExternalCacheDirs(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(BaseApplication.getInstance().getExternalCacheDirs()));
        }
        return list;
    }
    ...
    public String getExternalFilesDir(){
        ...
        File dir = BaseApplication.getInstance().getExternalFilesDir("aa");
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getExternalFilesDirs(){
        ...
        List<File> list = new ArrayList<>();
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(BaseApplication.getInstance().getExternalFilesDirs("aa")));
        }
        return list;
    }
    ...
    public String getObbDir(){
        File dir = BaseApplication.getInstance().getObbDir();
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getObbDirs(){
        ...
        List<File> list = new ArrayList<>();
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(BaseApplication.getInstance().getObbDirs()));
        }
    ...
    public String getNoBackupFilesDir(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            dir = BaseApplication.getInstance().getNoBackupFilesDir();
        }
    ...
    public String getCodeCacheDir(){
        File dir = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            dir = BaseApplication.getInstance().getCodeCacheDir();
        }
        return dir == null ? "" : dir.getAbsolutePath();
    }
    ...
    public String getDataDir(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            dir = BaseApplication.getInstance().getDataDir();
        }
        return dir == null ? "" : dir.getAbsolutePath();
    }
    ...
    public String getPackageCodePath(){
        String dir = BaseApplication.getInstance().getPackageCodePath();
        return dir;
    }
    ...
    public String getPackageResourcePath(){
        String dir = BaseApplication.getInstance().getPackageResourcePath();
        return dir;
    }
